    ...
    return (
        <div style={{ margin: "auto", textAlign: "center" }}>
            <div style={{ backgroundColor: "#ffffff", padding: "2vw", borderRadius: "8px", width: "92vw", margin: "2vw auto" }}>
                ...
                <p style={{ width: "70vw", margin: "auto" }}>発行されたQRコードをスキャンし、食券を発行します</p>
                <div style={{ display: "flex", margin: "5vw 0 13vw 0" }}>
                    <img src="/help/printer.svg" alt="menu" width={"50%"} style={{ transform: "rotate(-10deg)" }} />
                    <img src="/help/scanner.svg" alt="menu" width={"50%"} style={{ transform: "rotate(-10deg)" }} />
                </div>
            </div>
        </div>
    )
